...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage("ورود موفق! در حال هدایت...");
      setTimeout(() => {
        navigateTo("home");
      }, 500);
    } catch (err) {
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-[#181818] border border-[#282828] rounded-lg p-8 shadow-2xl">
          ...
          <div className="mt-8 space-y-4">
            <button
              ...
              className="w-full text-center text-sm text-[#1DB954] hover:text-[#1ED760] font-medium transition-colors"
            >
        ...
        <p className="text-center text-[#B3B3B3] text-xs mt-8">
          با استفاده از این سیستم شما شرایط و قوانین استفاده را می‌پذیرید
        </p>
      </div>
    </div>
  );
